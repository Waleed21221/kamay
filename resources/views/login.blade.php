                    ...
                    <div class="content-header bg-white-10">
                        ...
                        <a class="link-fx font-w600 font-size-lg text-white" href="index.html">
                            ...
                            <span class="smini-hidden">
                                <span class="text-white">Dash</span><span class="text-white-75">mix</span> <span class="text-white font-size-base font-w400">2.1</span>
                            </span>
                        </a>
                        <!-- END Logo -->
                ...
                <div class="content-side content-side-full">
                    <ul class="nav-main">
                        ...
                        <li class="nav-main-item open">
                            ...
                            <ul class="nav-main-submenu">
                                <li class="nav-main-item">
                                    <a class="nav-main-link active" href="be_pages_auth_all.html">
                                        <span class="nav-main-link-name">All</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
            ...
            <main id="main-container">
                ...
                <div class="content">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <!-- Sign In -->
                            <a class="block block-rounded block-bordered block-link-shadow" href="op_auth_signin.html">
                                <div class="block-content block-content-full">
                                    <div class="row py-4">
                        ...
                        <div class="col-md-6">
                            <!-- Sign Up -->
                            <a class="block block-rounded block-bordered block-link-shadow" href="op_auth_signup.html">
                                <div class="block-content block-content-full">
                                    <div class="row py-4">
                                        <div class="col-4 d-flex align-items-center justify-content-end border-right py-4">
                        ...
                        <div class="col-md-6">
                            <!-- Lock -->
                            <a class="block block-rounded block-bordered block-link-shadow" href="op_auth_lock.html">
                                <div class="block-content block-content-full">
                                    <div class="row py-4">
                                        <div class="col-4 d-flex align-items-center justify-content-end border-right py-4">
                        ...
                        <div class="col-md-6">
                            <!-- Password Reminder -->
                            <a class="block block-rounded block-bordered block-link-shadow" href="op_auth_reminder.html">
                                <div class="block-content block-content-full">
                                    <div class="row py-4">
                                        <div class="col-4 d-flex align-items-center justify-content-end border-right py-4">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <!-- Sign In Box -->
                            <a class="block block-rounded block-bordered block-link-shadow" href="op_auth_signin_box.html">
                                <div class="block-content block-content-full">
                                    <div class="row py-4">
                                        <div class="col-4 d-flex align-items-center justify-content-end border-right py-4">
                        ...
                        <div class="col-md-6">
                            <!-- Sign Up Box -->
                            <a class="block block-rounded block-bordered block-link-shadow" href="op_auth_signup_box.html">
                                <div class="block-content block-content-full">
                                    <div class="row py-4">
                                        <div class="col-4 d-flex align-items-center justify-content-end border-right py-4">
                        ...
                        <div class="col-md-6">
                            <!-- Lock Box -->
                            <a class="block block-rounded block-bordered block-link-shadow" href="op_auth_lock_box.html">
                                <div class="block-content block-content-full">
                                    <div class="row py-4">
                                        <div class="col-4 d-flex align-items-center justify-content-end border-right py-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <a class="block block-rounded block-bordered block-link-shadow" href="op_auth_reminder_box.html">
                                <div class="block-content block-content-full">
                                    <div class="row py-4">
                                        <div class="col-4 d-flex align-items-center justify-content-end border-right py-4">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <!-- Sign In Box Alt -->
                            <a class="block block-rounded block-bordered block-link-shadow" href="op_auth_signin_box_alt.html">
                                <div class="block-content block-content-full">
                                    <div class="row py-4">
                                        <div class="col-4 d-flex align-items-center justify-content-end border-right py-4">
                        ...
                        <div class="col-md-6">
                            <!-- Sign Up Box Alt -->
                            <a class="block block-rounded block-bordered block-link-shadow" href="op_auth_signup_box_alt.html">
                                <div class="block-content block-content-full">
                                    <div class="row py-4">
                                        <div class="col-4 d-flex align-items-center justify-content-end border-right py-4">
                        ...
                        <div class="col-md-6">
                            <!-- Lock Box Alt -->
                            <a class="block block-rounded block-bordered block-link-shadow" href="op_auth_lock_box_alt.html">
                                <div class="block-content block-content-full">
                                    <div class="row py-4">
                                        <div class="col-4 d-flex align-items-center justify-content-end border-right py-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <a class="block block-rounded block-bordered block-link-shadow" href="op_auth_reminder_box_alt.html">
                                <div class="block-content block-content-full">
                                    <div class="row py-4">
                                        <div class="col-4 d-flex align-items-center justify-content-end border-right py-4">
